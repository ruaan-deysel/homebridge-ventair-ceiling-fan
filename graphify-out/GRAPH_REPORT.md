...
## Corpus Check
- 19 files · ~20,717 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 130 nodes · 125 edges · 14 communities (10 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `09882247`
...
6. `Homebridge Ventair Ceiling Fan — v2 Modernisation Implementation Plan` - 5 edges
7. `scripts` - 5 edges
8. `CeilingFanAccessory` - 5 edges
...
Cohesion: 0.08
Nodes (24): bugs, url, dependencies, tuyapi, description, displayName, engines, homebridge (+16 more)
...
## Knowledge Gaps
- **88 isolated node(s):** `Measured facts (do not re-derive)`, `Conventions`, `Task #11: Confirm numeric DP indices over the LAN`, `Task #1: Migrate packaging and tooling to ESM / Homebridge v2`, `Task #3: Build dps.ts — single-source DPS mapping` (+83 more)
...
- **What connects `Measured facts (do not re-derive)`, `Conventions`, `Task #11: Confirm numeric DP indices over the LAN` to the rest of the system?**
